...
public class StudentsManagerFileImpl implements StudentsManager {
    ...
    private String file = "/Users/chendanni/Desktop/students.txt";
    ...
    private void writeIntoFile(Student student) {
        try {
            ...
            ps.println(student.getId() + "|" + student.getName() + "｜" + student.getGender() + "|" + student.getCountry());
            fos.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void rewriteContentsIntoFile() {
        ...
        try {
            ...
            for (Student s : manager.getStudents()) {
                ps.println(s.getId() + "|" + s.getName()+ "｜" + s.getGender() + "|" + s.getCountry());
            }
